...
[![CircleCI](https://circleci.com/gh/cnruby/gradle_kotlin/tree/basic_101.svg?style=svg)](https://app.circleci.com/pipelines/github/cnruby/gradle_kotlin?branch=basic_101)
...
- [install `git`, `wget` and `curl`](#install-git-wget-and-curl)
